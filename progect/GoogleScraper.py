...
GoogleScraper -m selenium --keyword-file /usr/python/progect/p.txt -v2

GoogleScraper -m http --keyword-file /usr/python/progect/p.txt --num-workers 50 --proxy-file proxies.txt --search-engines "google,bing,yahoo,Baidu" --output-filename /usr/python/progect/output.json -v2

GoogleScraper -m http --keyword-file /usr/python/progect/p.txt --num-workers 50 --search-engines "google,bing,yahoo,Baidu" --output-filename /usr/python/progect/output.json -v2
